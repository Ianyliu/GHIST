...
def main(config):
    ...
    # subprocess.run(f"/home/ian/miniforge3/envs/hovernet/bin/python 5_segment_nuclei_he_image.py --dir_output {dir_output} --fp_he_img {fp_he_img} --dir_hovernet {dir_hovernet} --gpu_id {gpu_id} --step 2", shell=True, executable=f"/bin/{shell}")
    ...
    # subprocess.run(f"/home/ian/miniforge3/envs/ghist/bin/python 5_segment_nuclei_he_image.py --dir_output {dir_output} --fp_he_img {fp_he_img} --dir_hovernet {dir_hovernet} --gpu_id {gpu_id} --step 3", shell=True, executable=f"/bin/{shell}")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dir_output",
        default="data_processed_Xenium_V1_FFPE_Preview_Human_Breast_Cancer_Sample_2",
        type=str,
        help="dir of processed data",
    )
    parser.add_argument(
        "--dir_xenium_outs",
        default="/home/ian/data/GHIST-test-data/Xenium_V1_FFPE_Preview_Human_Breast_Cancer_Sample_2/Xenium_V1_FFPE_Preview_Human_Breast_Cancer_Sample_2_outs",
        type=str,
        help="dir of Xenium outputs",
    )
    parser.add_argument(
        "--fp_he_img",
        default="/home/ian/data/GHIST-test-data/Xenium_V1_FFPE_Preview_Human_Breast_Cancer_Sample_2/Xenium_V1_FFPE_Preview_Human_Breast_Cancer_Sample_2_he_image.ome.tif",
        type=str,
        help="file path of H&E image",
    )
    parser.add_argument(
        "--dir_hovernet",
        default="/home/ian/Code/hover_net",
        type=str,
